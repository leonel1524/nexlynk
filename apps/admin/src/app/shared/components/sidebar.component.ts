  ...
  template: `
    <aside class="w-64 bg-white border-r border-gray-200 flex flex-col">
      ...
      <nav class="flex-1 p-4 space-y-1">
        ...
        <a routerLink="/businesses" routerLinkActive="active" class="sidebar-link">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a routerLink="/businesses" [queryParams]="{view: 'analytics'}" routerLinkActive="active" class="sidebar-link">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
